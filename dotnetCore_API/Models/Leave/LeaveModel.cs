...
{
    public class LeaveModel : GetLeaveModel
    {
    ...
    public class GetLeaveModel
    {
        ...
        public string str_create_date => create_date.Value.ToString("dd/MM/yyyy HH:mm:ss");
        public string str_update_date => update_date.Value.ToString("dd/MM/yyyy HH:mm:ss");
